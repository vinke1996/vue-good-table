...
(function (global, factory) {
  ...
  var script$4 = {
    ...
    computed: {},
    methods: {
      fieldToString: function fieldToString(column) {
  ...
  var __vue_scope_id__$4 = "data-v-34905db8";
  /* module identifier */
  ...
  $export($export.S + $export.F * !__webpack_require__(80)(function (iter) { }), 'Array', {
  ...
  $export($export.S + $export.F * !__webpack_require__(83)(function (iter) { }), 'Array', {
    // 22.1.2.1 Array.from(arrayLike, mapfn = undefined, thisArg = undefined)
    from: function from(arrayLike /* , mapfn = undefined, thisArg = undefined */) {
      var O = toObject(arrayLike);
      var C = typeof this == 'function' ? this : Array;
  ...
  var script$6 = {
    ...
    methods: {
      reorderColumns: function reorderColumns(arr, oldIndex, newIndex) {
        var tmpColumn = arr[oldIndex];
    ...
    mounted: function mounted() {
      ...
      this.$nextTick(function () {
        var ref = _this6.fixedHeader ? _this6.$refs['table-header-secondary'] : _this6.$refs['table-header-primary'];
        var sortColumns = new Sortable(ref.$el.firstElementChild, {
        ...
        sortColumns.on('sortable:stop', function (e) {
          _this6.columns = _this6.reorderColumns(_this6.columns, e.oldIndex, e.newIndex);

          _this6.$emit('on-column-dragged', e);
        });
      });
    },
    components: {
